...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'DISTORTED WAVY LIQUID TEXT // SET 04';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Distorted Wavy Liquid Text Variation 04' typography treatment from 'Distorted Wavy Liquid Text':
