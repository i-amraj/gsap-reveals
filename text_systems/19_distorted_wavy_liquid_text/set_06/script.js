...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'DISTORTED WAVY LIQUID TEXT // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Distorted Wavy Liquid Text Variation 06' typography treatment from 'Distorted Wavy Liquid Text':
