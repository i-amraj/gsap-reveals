# AI Typography Prompt: Distorted Wavy Liquid Text Variation 06 (Distorted Wavy Liquid Text)

```markdown
Apply the 'Distorted Wavy Liquid Text Variation 06' typography style from the Distorted Wavy Liquid Text system to all display headings and hero banners.
