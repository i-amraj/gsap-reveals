...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'HANDWRITTEN CALLIGRAPHY SCRIPT // SET 03';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Handwritten Calligraphy Script Variation 03' typography treatment from 'Handwritten Calligraphy Script':
