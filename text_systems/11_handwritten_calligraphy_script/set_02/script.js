...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'HANDWRITTEN CALLIGRAPHY SCRIPT // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Handwritten Calligraphy Script Variation 02' typography treatment from 'Handwritten Calligraphy Script':
