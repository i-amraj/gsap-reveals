...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'HANDWRITTEN CALLIGRAPHY SCRIPT // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Handwritten Calligraphy Script Variation 06' typography treatment from 'Handwritten Calligraphy Script':
