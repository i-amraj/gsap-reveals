...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SWISS INTERNATIONAL GRID TYPE // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Swiss International Grid Type Variation 02' typography treatment from 'Swiss International Grid Type':
