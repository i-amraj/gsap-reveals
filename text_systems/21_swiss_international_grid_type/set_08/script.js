...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SWISS INTERNATIONAL GRID TYPE // SET 08';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Swiss International Grid Type Variation 08' typography treatment from 'Swiss International Grid Type':
