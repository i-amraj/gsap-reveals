# AI Typography Prompt: Swiss International Grid Type Variation 03 (Swiss International Grid Type)

```markdown
Apply the 'Swiss International Grid Type Variation 03' typography style from the Swiss International Grid Type system to all display headings and hero banners.
