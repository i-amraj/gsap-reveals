# AI Typography Prompt: Swiss International Grid Type Variation 04 (Swiss International Grid Type)

```markdown
Apply the 'Swiss International Grid Type Variation 04' typography style from the Swiss International Grid Type system to all display headings and hero banners.
