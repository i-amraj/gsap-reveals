...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'root@cyber-core:~# execute_pipeline';
});
...
color: #00f3ff; text-shadow: 0 0 10px rgba(0,243,255,0.6);`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Cyberpunk Shell Prompt' typography treatment from 'Typewriter Terminal CLI':
- Font Family: 'Share Tech Mono', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.04em
- Text Transform: none
- Custom Styling: color: #00f3ff; text-shadow: 0 0 10px rgba(0,243,255,0.6);
