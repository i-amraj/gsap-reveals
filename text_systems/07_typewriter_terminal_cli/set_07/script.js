...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'CONNECTING TO HOST: 192.168.1.1';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Amber CRT Monochrome' typography treatment from 'Typewriter Terminal CLI':
- Font Family: 'Space Mono', sans-serif (Google Fonts)
- Weight: 700
- Tracking / Spacing: 0.02em
- Text Transform: none
- Custom Styling: color: #f59e0b; text-shadow: 0 0 10px rgba(245,158,11,0.5);
