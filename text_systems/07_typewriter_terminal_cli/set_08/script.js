...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'ORBITAL TRAJECTORY: LOCKED';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Inconsolata', sans-serif;
font-weight: 900;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'NASA Telemetry Terminal' typography treatment from 'Typewriter Terminal CLI':
- Font Family: 'Inconsolata', sans-serif (Google Fonts)
- Weight: 900
- Tracking / Spacing: 0.04em
- Text Transform: uppercase
- Custom Styling: color: #38bdf8;
