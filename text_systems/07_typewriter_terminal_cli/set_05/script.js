...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'timeline.to(element, { x: 500 });';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Mechanical Cherry MX Clack' typography treatment from 'Typewriter Terminal CLI':
- Font Family: 'Fira Code', sans-serif (Google Fonts)
- Weight: 600
- Tracking / Spacing: -0.01em
- Text Transform: none
- Custom Styling: color: #facc15;
