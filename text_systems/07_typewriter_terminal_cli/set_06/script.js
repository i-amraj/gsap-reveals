...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'A timeless screenplay by Stanley K.';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Courier Prime', sans-serif;
font-weight: 700;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Cursive Typewriter Script' typography treatment from 'Typewriter Terminal CLI':
- Font Family: 'Courier Prime', sans-serif (Google Fonts)
- Weight: 700
- Tracking / Spacing: 0.02em
- Text Transform: none
- Custom Styling: color: #fafaf9;
