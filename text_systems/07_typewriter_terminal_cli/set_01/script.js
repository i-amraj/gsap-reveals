...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || '$ npm install @gsap/core --save';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Bash Prompt Green' typography treatment from 'Typewriter Terminal CLI':
- Font Family: 'JetBrains Mono', sans-serif (Google Fonts)
- Weight: 700
- Tracking / Spacing: 0.02em
- Text Transform: none
- Custom Styling: color: #10b981; font-family: 'JetBrains Mono', monospace;
