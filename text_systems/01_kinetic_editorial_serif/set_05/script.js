...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'THE MODERN SALON';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Prata', sans-serif;
font-weight: 400;
letter-spacing: 0.04em;
text-transform: uppercase;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #fafaf9; letter-spacing: 0.18em;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Prata Modern Luxury' typography treatment from 'Kinetic Editorial Serif':
- Font Family: 'Prata', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.04em
- Text Transform: uppercase
- Custom Styling: color: #fafaf9; letter-spacing: 0.18em;
