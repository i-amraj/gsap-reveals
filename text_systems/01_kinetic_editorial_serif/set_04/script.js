...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'Architectural Serifs';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Bodoni Moda', sans-serif;
font-weight: 800;
letter-spacing: -0.03em;
text-transform: none;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #ffffff; text-decoration: underline; text-decoration-color: #38bdf8;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Bodoni Dramatic Contrast' typography treatment from 'Kinetic Editorial Serif':
- Font Family: 'Bodoni Moda', sans-serif (Google Fonts)
- Weight: 800
- Tracking / Spacing: -0.03em
- Text Transform: none
- Custom Styling: color: #ffffff; text-decoration: underline; text-decoration-color: #38bdf8;
