...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'CHRONICLES';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Editorial Magazine Masthead' typography treatment from 'Kinetic Editorial Serif':
- Font Family: 'Playfair Display', sans-serif (Google Fonts)
- Weight: 900
- Tracking / Spacing: -0.04em
- Text Transform: uppercase
- Custom Styling: background: linear-gradient(180deg, #fff 0%, #94a3b8 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;
