...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'Milano Senza Tempo';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Italiana', sans-serif;
font-weight: 400;
letter-spacing: 0.06em;
text-transform: none;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #fed7aa; font-size: 1.1em;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Italiana Minimalist Chic' typography treatment from 'Kinetic Editorial Serif':
- Font Family: 'Italiana', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.06em
- Text Transform: none
- Custom Styling: color: #fed7aa; font-size: 1.1em;
