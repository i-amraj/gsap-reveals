# AI Typography Prompt: Variable Font Dynamic Axis Variation 02 (Variable Font Dynamic Axis)

```markdown
Apply the 'Variable Font Dynamic Axis Variation 02' typography style from the Variable Font Dynamic Axis system to all display headings and hero banners.
