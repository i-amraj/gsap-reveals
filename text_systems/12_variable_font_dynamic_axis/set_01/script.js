...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'VARIABLE FONT DYNAMIC AXIS // SET 01';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Variable Font Dynamic Axis Variation 01' typography treatment from 'Variable Font Dynamic Axis':
