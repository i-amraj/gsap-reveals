...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'VARIABLE FONT DYNAMIC AXIS // SET 05';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Variable Font Dynamic Axis Variation 05' typography treatment from 'Variable Font Dynamic Axis':
