...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'CURVED MOTIONPATH TEXT // SET 07';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Curved MotionPath Text Variation 07' typography treatment from 'Curved MotionPath Text':
