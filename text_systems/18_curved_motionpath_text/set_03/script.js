...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'CURVED MOTIONPATH TEXT // SET 03';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Curved MotionPath Text Variation 03' typography treatment from 'Curved MotionPath Text':
