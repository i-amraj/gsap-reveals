# AI Typography Prompt: Curved MotionPath Text Variation 02 (Curved MotionPath Text)

```markdown
Apply the 'Curved MotionPath Text Variation 02' typography style from the Curved MotionPath Text system to all display headings and hero banners.
