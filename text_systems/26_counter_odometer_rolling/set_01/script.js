...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'COUNTER ODOMETER ROLLING // SET 01';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Counter Odometer Rolling Variation 01' typography treatment from 'Counter Odometer Rolling':
