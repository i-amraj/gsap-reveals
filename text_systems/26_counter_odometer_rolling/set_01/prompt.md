# AI Typography Prompt: Counter Odometer Rolling Variation 01 (Counter Odometer Rolling)

```markdown
Apply the 'Counter Odometer Rolling Variation 01' typography style from the Counter Odometer Rolling system to all display headings and hero banners.
