# AI Typography Prompt: Counter Odometer Rolling Variation 06 (Counter Odometer Rolling)

```markdown
Apply the 'Counter Odometer Rolling Variation 06' typography style from the Counter Odometer Rolling system to all display headings and hero banners.
