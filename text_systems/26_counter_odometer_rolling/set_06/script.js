...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'COUNTER ODOMETER ROLLING // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Counter Odometer Rolling Variation 06' typography treatment from 'Counter Odometer Rolling':
