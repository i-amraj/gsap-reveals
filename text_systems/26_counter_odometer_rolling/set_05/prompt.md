# AI Typography Prompt: Counter Odometer Rolling Variation 05 (Counter Odometer Rolling)

```markdown
Apply the 'Counter Odometer Rolling Variation 05' typography style from the Counter Odometer Rolling system to all display headings and hero banners.
