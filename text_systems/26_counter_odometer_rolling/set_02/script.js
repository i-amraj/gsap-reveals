...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'COUNTER ODOMETER ROLLING // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Counter Odometer Rolling Variation 02' typography treatment from 'Counter Odometer Rolling':
