...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'COUNTER ODOMETER ROLLING // SET 03';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Counter Odometer Rolling Variation 03' typography treatment from 'Counter Odometer Rolling':
