# AI Typography Prompt: Counter Odometer Rolling Variation 04 (Counter Odometer Rolling)

```markdown
Apply the 'Counter Odometer Rolling Variation 04' typography style from the Counter Odometer Rolling system to all display headings and hero banners.
