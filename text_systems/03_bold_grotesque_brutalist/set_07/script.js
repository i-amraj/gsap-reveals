...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'BREAKING GROUND';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Oswald', sans-serif;
font-weight: 700;
letter-spacing: -0.01em;
text-transform: uppercase;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #f97316; font-size: 1.2em;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Oswald Bold Headline' typography treatment from 'Bold Grotesque Brutalist':
- Font Family: 'Oswald', sans-serif (Google Fonts)
- Weight: 700
- Tracking / Spacing: -0.01em
- Text Transform: uppercase
- Custom Styling: color: #f97316; font-size: 1.2em;
