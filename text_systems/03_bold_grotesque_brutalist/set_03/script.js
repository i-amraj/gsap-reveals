...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'RAW MONUMENT';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Anton Poster Heavy' typography treatment from 'Bold Grotesque Brutalist':
- Font Family: 'Anton', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.02em
- Text Transform: uppercase
- Custom Styling: color: #ef4444; font-size: 1.25em;
