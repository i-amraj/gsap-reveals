# AI Typography Prompt: Anton Poster Heavy (Bold Grotesque Brutalist)

```markdown
Apply the 'Anton Poster Heavy' typography style from the Bold Grotesque Brutalist system to all display headings and hero banners.
