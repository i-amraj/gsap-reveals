...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'URBAN ARCHITECTURE';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Fjalla One', sans-serif;
font-weight: 400;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Fjalla Bold Contrast' typography treatment from 'Bold Grotesque Brutalist':
- Font Family: 'Fjalla One', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.02em
- Text Transform: uppercase
- Custom Styling: color: #ffffff;
