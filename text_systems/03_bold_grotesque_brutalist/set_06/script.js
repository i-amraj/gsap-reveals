...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'INDUSTRIAL TOWER';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Teko', sans-serif;
font-weight: 700;
letter-spacing: 0.05em;
text-transform: uppercase;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #e2e8f0; font-size: 1.4em; line-height: 0.9;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Teko Tall Condensed' typography treatment from 'Bold Grotesque Brutalist':
- Font Family: 'Teko', sans-serif (Google Fonts)
- Weight: 700
- Tracking / Spacing: 0.05em
- Text Transform: uppercase
- Custom Styling: color: #e2e8f0; font-size: 1.4em; line-height: 0.9;
