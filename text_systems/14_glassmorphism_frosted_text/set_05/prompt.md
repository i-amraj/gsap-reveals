# AI Typography Prompt: Glassmorphism Frosted Text Variation 05 (Glassmorphism Frosted Text)

```markdown
Apply the 'Glassmorphism Frosted Text Variation 05' typography style from the Glassmorphism Frosted Text system to all display headings and hero banners.
