...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'GLASSMORPHISM FROSTED TEXT // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Glassmorphism Frosted Text Variation 02' typography treatment from 'Glassmorphism Frosted Text':
