...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'GLASSMORPHISM FROSTED TEXT // SET 01';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Glassmorphism Frosted Text Variation 01' typography treatment from 'Glassmorphism Frosted Text':
