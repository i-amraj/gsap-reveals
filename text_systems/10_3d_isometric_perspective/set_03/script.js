...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || '3D ISOMETRIC PERSPECTIVE // SET 03';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the '3D Isometric Perspective Variation 03' typography treatment from '3D Isometric Perspective':
