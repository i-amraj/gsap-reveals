# AI Typography Prompt: 3D Isometric Perspective Variation 04 (3D Isometric Perspective)

```markdown
Apply the '3D Isometric Perspective Variation 04' typography style from the 3D Isometric Perspective system to all display headings and hero banners.
