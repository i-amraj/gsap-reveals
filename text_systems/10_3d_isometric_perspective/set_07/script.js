...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || '3D ISOMETRIC PERSPECTIVE // SET 07';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the '3D Isometric Perspective Variation 07' typography treatment from '3D Isometric Perspective':
