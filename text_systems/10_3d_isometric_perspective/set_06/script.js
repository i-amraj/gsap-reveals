...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || '3D ISOMETRIC PERSPECTIVE // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the '3D Isometric Perspective Variation 06' typography treatment from '3D Isometric Perspective':
