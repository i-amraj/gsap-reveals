# AI Typography Prompt: 3D Isometric Perspective Variation 06 (3D Isometric Perspective)

```markdown
Apply the '3D Isometric Perspective Variation 06' typography style from the 3D Isometric Perspective system to all display headings and hero banners.
