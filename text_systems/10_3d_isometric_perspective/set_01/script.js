...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || '3D ISOMETRIC PERSPECTIVE // SET 01';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the '3D Isometric Perspective Variation 01' typography treatment from '3D Isometric Perspective':
