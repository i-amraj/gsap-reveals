...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'AI GENERATIVE FUTURE TYPE // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'AI Generative Future Type Variation 06' typography treatment from 'AI Generative Future Type':
