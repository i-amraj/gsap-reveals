# AI Typography Prompt: AI Generative Future Type Variation 06 (AI Generative Future Type)

```markdown
Apply the 'AI Generative Future Type Variation 06' typography style from the AI Generative Future Type system to all display headings and hero banners.
