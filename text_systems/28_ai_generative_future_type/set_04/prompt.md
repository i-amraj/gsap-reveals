# AI Typography Prompt: AI Generative Future Type Variation 04 (AI Generative Future Type)

```markdown
Apply the 'AI Generative Future Type Variation 04' typography style from the AI Generative Future Type system to all display headings and hero banners.
