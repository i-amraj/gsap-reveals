...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'STENCIL MILITARY INDUSTRIAL // SET 07';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Stencil Military Industrial Variation 07' typography treatment from 'Stencil Military Industrial':
