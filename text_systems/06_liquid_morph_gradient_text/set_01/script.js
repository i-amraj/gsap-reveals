...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'AURORA SHIFT';
});
...
background: linear-gradient(135deg, #00f2fe 0%, #4facfe 30%, #00ff87 60%, #60efff 100%); background-size: 300% 300%; -webkit-background-clip: text; -webkit-text-fill-color: transparent;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Aurora Borealis Mesh' typography treatment from 'Liquid Morph Gradient Text':
- Font Family: 'Space Grotesk', sans-serif (Google Fonts)
- Weight: 800
- Tracking / Spacing: -0.03em
- Text Transform: uppercase
- Custom Styling: background: linear-gradient(135deg, #00f2fe 0%, #4facfe 30%, #00ff87 60%, #60efff 100%); background-size: 300% 300%; -webkit-background-clip: text; -webkit-text-fill-color: transparent;
