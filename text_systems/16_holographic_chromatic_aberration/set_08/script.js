...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'HOLOGRAPHIC CHROMATIC ABERRATION // SET 08';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Holographic Chromatic Aberration Variation 08' typography treatment from 'Holographic Chromatic Aberration':
