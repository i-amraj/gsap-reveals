...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'HOLOGRAPHIC CHROMATIC ABERRATION // SET 04';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Holographic Chromatic Aberration Variation 04' typography treatment from 'Holographic Chromatic Aberration':
