# AI Typography Prompt: Smoke Particle Dissolve Variation 05 (Smoke Particle Dissolve)

```markdown
Apply the 'Smoke Particle Dissolve Variation 05' typography style from the Smoke Particle Dissolve system to all display headings and hero banners.
