...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SMOKE PARTICLE DISSOLVE // SET 08';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Smoke Particle Dissolve Variation 08' typography treatment from 'Smoke Particle Dissolve':
