...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SMOKE PARTICLE DISSOLVE // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Smoke Particle Dissolve Variation 06' typography treatment from 'Smoke Particle Dissolve':
