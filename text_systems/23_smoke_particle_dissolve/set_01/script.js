...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SMOKE PARTICLE DISSOLVE // SET 01';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Smoke Particle Dissolve Variation 01' typography treatment from 'Smoke Particle Dissolve':
