# AI Typography Prompt: Smoke Particle Dissolve Variation 01 (Smoke Particle Dissolve)

```markdown
Apply the 'Smoke Particle Dissolve Variation 01' typography style from the Smoke Particle Dissolve system to all display headings and hero banners.
