...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'MASKED CLIP-PATH REVEALS // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Masked Clip-Path Reveals Variation 02' typography treatment from 'Masked Clip-Path Reveals':
