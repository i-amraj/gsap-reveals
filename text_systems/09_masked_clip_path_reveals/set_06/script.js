...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'MASKED CLIP-PATH REVEALS // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Masked Clip-Path Reveals Variation 06' typography treatment from 'Masked Clip-Path Reveals':
