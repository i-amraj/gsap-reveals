# AI Typography Prompt: Masked Clip-Path Reveals Variation 08 (Masked Clip-Path Reveals)

```markdown
Apply the 'Masked Clip-Path Reveals Variation 08' typography style from the Masked Clip-Path Reveals system to all display headings and hero banners.
