# AI Typography Prompt: Shadow Layered Depth Stack Variation 01 (Shadow Layered Depth Stack)

```markdown
Apply the 'Shadow Layered Depth Stack Variation 01' typography style from the Shadow Layered Depth Stack system to all display headings and hero banners.
