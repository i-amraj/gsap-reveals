...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SHADOW LAYERED DEPTH STACK // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Shadow Layered Depth Stack Variation 06' typography treatment from 'Shadow Layered Depth Stack':
