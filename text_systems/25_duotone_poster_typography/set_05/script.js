...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'DUOTONE POSTER TYPOGRAPHY // SET 05';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Duotone Poster Typography Variation 05' typography treatment from 'Duotone Poster Typography':
