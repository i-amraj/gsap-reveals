...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'DUOTONE POSTER TYPOGRAPHY // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Duotone Poster Typography Variation 06' typography treatment from 'Duotone Poster Typography':
