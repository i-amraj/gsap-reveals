...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'DUOTONE POSTER TYPOGRAPHY // SET 04';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Duotone Poster Typography Variation 04' typography treatment from 'Duotone Poster Typography':
