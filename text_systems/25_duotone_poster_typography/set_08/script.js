...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'DUOTONE POSTER TYPOGRAPHY // SET 08';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Duotone Poster Typography Variation 08' typography treatment from 'Duotone Poster Typography':
