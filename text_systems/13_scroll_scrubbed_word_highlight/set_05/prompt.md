# AI Typography Prompt: Scroll Scrubbed Word Highlight Variation 05 (Scroll Scrubbed Word Highlight)

```markdown
Apply the 'Scroll Scrubbed Word Highlight Variation 05' typography style from the Scroll Scrubbed Word Highlight system to all display headings and hero banners.
