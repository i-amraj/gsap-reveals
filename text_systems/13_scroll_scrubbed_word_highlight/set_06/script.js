...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SCROLL SCRUBBED WORD HIGHLIGHT // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Scroll Scrubbed Word Highlight Variation 06' typography treatment from 'Scroll Scrubbed Word Highlight':
