...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'Cocktails & Jazz';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Yellowtail', sans-serif;
font-weight: 400;
letter-spacing: 0.02em;
text-transform: none;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #fff; text-shadow: 0 0 5px #f43f5e, 0 0 15px #f43f5e, 0 0 30px #e11d48;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Neon Script Cocktail' typography treatment from 'Neon Glow Signage':
- Font Family: 'Yellowtail', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.02em
- Text Transform: none
- Custom Styling: color: #fff; text-shadow: 0 0 5px #f43f5e, 0 0 15px #f43f5e, 0 0 30px #e11d48;
