...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'OPEN LATE';
});
...
color: #fff; text-shadow: 0 0 5px #e2e8f0, 0 0 15px #38bdf8, 0 0 30px #0284c7;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Halogen Ice Sign' typography treatment from 'Neon Glow Signage':
- Font Family: 'Space Grotesk', sans-serif (Google Fonts)
- Weight: 700
- Tracking / Spacing: 0.15em
- Text Transform: uppercase
- Custom Styling: color: #fff; text-shadow: 0 0 5px #e2e8f0, 0 0 15px #38bdf8, 0 0 30px #0284c7;
