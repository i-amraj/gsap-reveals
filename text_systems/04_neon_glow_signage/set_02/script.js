...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'NEON DREAMS';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'Monoton', sans-serif;
font-weight: 400;
letter-spacing: 0.06em;
text-transform: uppercase;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #fff; text-shadow: 0 0 5px #ff007f, 0 0 15px #ff007f, 0 0 30px #e11d48, 0 0 60px #be123c;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Hot Pink Neon Motel' typography treatment from 'Neon Glow Signage':
- Font Family: 'Monoton', sans-serif (Google Fonts)
- Weight: 400
- Tracking / Spacing: 0.06em
- Text Transform: uppercase
- Custom Styling: color: #fff; text-shadow: 0 0 5px #ff007f, 0 0 15px #ff007f, 0 0 30px #e11d48, 0 0 60px #be123c;
