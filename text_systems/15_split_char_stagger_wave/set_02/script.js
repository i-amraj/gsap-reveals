...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SPLIT CHAR STAGGER WAVE // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Split Char Stagger Wave Variation 02' typography treatment from 'Split Char Stagger Wave':
