# AI Typography Prompt: Split Char Stagger Wave Variation 01 (Split Char Stagger Wave)

```markdown
Apply the 'Split Char Stagger Wave Variation 01' typography style from the Split Char Stagger Wave system to all display headings and hero banners.
