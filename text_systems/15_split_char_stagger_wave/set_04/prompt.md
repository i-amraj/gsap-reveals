# AI Typography Prompt: Split Char Stagger Wave Variation 04 (Split Char Stagger Wave)

```markdown
Apply the 'Split Char Stagger Wave Variation 04' typography style from the Split Char Stagger Wave system to all display headings and hero banners.
