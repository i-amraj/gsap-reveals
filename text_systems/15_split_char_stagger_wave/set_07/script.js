...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'SPLIT CHAR STAGGER WAVE // SET 07';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Split Char Stagger Wave Variation 07' typography treatment from 'Split Char Stagger Wave':
