...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'BUBBLE BLOBITECTURE POP // SET 06';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Bubble Blobitecture Pop Variation 06' typography treatment from 'Bubble Blobitecture Pop':
