# AI Typography Prompt: Bubble Blobitecture Pop Variation 07 (Bubble Blobitecture Pop)

```markdown
Apply the 'Bubble Blobitecture Pop Variation 07' typography style from the Bubble Blobitecture Pop system to all display headings and hero banners.
