...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'KINETIC MARQUEE INFINITE // SET 04';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Kinetic Marquee Infinite Variation 04' typography treatment from 'Kinetic Marquee Infinite':
