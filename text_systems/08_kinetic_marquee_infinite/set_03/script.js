...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'KINETIC MARQUEE INFINITE // SET 03';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Kinetic Marquee Infinite Variation 03' typography treatment from 'Kinetic Marquee Infinite':
