# AI Typography Prompt: Kinetic Marquee Infinite Variation 01 (Kinetic Marquee Infinite)

```markdown
Apply the 'Kinetic Marquee Infinite Variation 01' typography style from the Kinetic Marquee Infinite system to all display headings and hero banners.
