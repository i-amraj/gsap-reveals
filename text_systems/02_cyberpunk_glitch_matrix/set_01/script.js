...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'NEURAL OVERDRIVE';
});
...
copyCssBtn.addEventListener('click', () => {
  const css = `font-family: 'JetBrains Mono', sans-serif;
font-weight: 800;
letter-spacing: 0.05em;
text-transform: uppercase;
font-size: clamp(2.5rem, 6vw, 4.8rem);
color: #fff; text-shadow: -3px 0 #00f3ff, 3px 0 #ff0055;`;
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'RGB Channel Split Glitch' typography treatment from 'Cyberpunk Glitch Matrix':
- Font Family: 'JetBrains Mono', sans-serif (Google Fonts)
- Weight: 800
- Tracking / Spacing: 0.05em
- Text Transform: uppercase
- Custom Styling: color: #fff; text-shadow: -3px 0 #00f3ff, 3px 0 #ff0055;
