...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'GOLDEN LUXURY EMBOSS // SET 08';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Golden Luxury Emboss Variation 08' typography treatment from 'Golden Luxury Emboss':
