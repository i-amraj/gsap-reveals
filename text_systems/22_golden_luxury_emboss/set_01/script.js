...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'GOLDEN LUXURY EMBOSS // SET 01';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Golden Luxury Emboss Variation 01' typography treatment from 'Golden Luxury Emboss':
