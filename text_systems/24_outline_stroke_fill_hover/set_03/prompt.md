# AI Typography Prompt: Outline Stroke Fill Hover Variation 03 (Outline Stroke Fill Hover)

```markdown
Apply the 'Outline Stroke Fill Hover Variation 03' typography style from the Outline Stroke Fill Hover system to all display headings and hero banners.
