...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'OUTLINE STROKE FILL HOVER // SET 02';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Outline Stroke Fill Hover Variation 02' typography treatment from 'Outline Stroke Fill Hover':
