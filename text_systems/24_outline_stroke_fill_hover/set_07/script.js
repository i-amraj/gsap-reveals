...
textInput.addEventListener('input', (e) => {
  heroText.textContent = e.target.value || 'OUTLINE STROKE FILL HOVER // SET 07';
});
...
copyPromptBtn.addEventListener('click', () => {
  const p = `Use the 'Outline Stroke Fill Hover Variation 07' typography treatment from 'Outline Stroke Fill Hover':
