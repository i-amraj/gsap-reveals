# AI Component Prompt: Featured Center Highlight Card (Pricing Tables & Cards)

```markdown
Implement the 'Featured Center Highlight Card' component from the Pricing Tables & Cards system into the webpage layout.
