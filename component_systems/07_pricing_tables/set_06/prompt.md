# AI Component Prompt: Compact Comparison Row Table (Pricing Tables & Cards)

```markdown
Implement the 'Compact Comparison Row Table' component from the Pricing Tables & Cards system into the webpage layout.
