# AI Component Prompt: AI Compute Token Tier Cards (Pricing Tables & Cards)

```markdown
Implement the 'AI Compute Token Tier Cards' component from the Pricing Tables & Cards system into the webpage layout.
