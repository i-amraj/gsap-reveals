# AI Component Prompt: Minimalist Dark Pricing Matrix (Pricing Tables & Cards)

```markdown
Implement the 'Minimalist Dark Pricing Matrix' component from the Pricing Tables & Cards system into the webpage layout.

Component Specifications:
- Category: Commerce & Conversion
- Component Pattern: pricing
- Accent Color: #f8fafc
