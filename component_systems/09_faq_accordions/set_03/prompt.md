# AI Component Prompt: Glassmorphic Frosted FAQ Box (FAQ Accordions)

```markdown
Implement the 'Glassmorphic Frosted FAQ Box' component from the FAQ Accordions system into the webpage layout.

Component Specifications:
- Category: Content & Support
- Component Pattern: accordion
- Accent Color: #f8fafc
