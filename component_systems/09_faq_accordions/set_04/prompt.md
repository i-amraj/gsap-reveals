# AI Component Prompt: Two-Column Split FAQ Matrix (FAQ Accordions)

```markdown
Implement the 'Two-Column Split FAQ Matrix' component from the FAQ Accordions system into the webpage layout.
