# AI Component Prompt: Numbered Step-by-Step FAQ (FAQ Accordions)

```markdown
Implement the 'Numbered Step-by-Step FAQ' component from the FAQ Accordions system into the webpage layout.
