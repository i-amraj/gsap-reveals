# AI Component Prompt: Raycast Floating Search Bar (Command Bar & Search (Cmd+K))

```markdown
Implement the 'Raycast Floating Search Bar' component from the Command Bar & Search (Cmd+K) system into the webpage layout.
