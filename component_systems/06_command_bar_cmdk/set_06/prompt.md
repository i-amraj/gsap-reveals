# AI Component Prompt: Studio Asset Filter Modal (Command Bar & Search (Cmd+K))

```markdown
Implement the 'Studio Asset Filter Modal' component from the Command Bar & Search (Cmd+K) system into the webpage layout.
