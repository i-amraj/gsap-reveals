# AI Component Prompt: Linear Style Spotlight Cmd+K (Command Bar & Search (Cmd+K))

```markdown
Implement the 'Linear Style Spotlight Cmd+K' component from the Command Bar & Search (Cmd+K) system into the webpage layout.
