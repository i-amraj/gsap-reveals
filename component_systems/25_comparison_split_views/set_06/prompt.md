# AI Component Prompt: Mobile vs Desktop Preview Toggle (Comparison & Split Views)

```markdown
Implement the 'Mobile vs Desktop Preview Toggle' component from the Comparison & Split Views system into the webpage layout.

Component Specifications:
- Category: Interactivity & Proof
