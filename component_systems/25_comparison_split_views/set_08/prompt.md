# AI Component Prompt: Dual Metric Benchmarking Bar (Comparison & Split Views)

```markdown
Implement the 'Dual Metric Benchmarking Bar' component from the Comparison & Split Views system into the webpage layout.
