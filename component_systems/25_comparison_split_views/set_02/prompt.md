# AI Component Prompt: Side-by-Side Feature Matrix (Comparison & Split Views)

```markdown
Implement the 'Side-by-Side Feature Matrix' component from the Comparison & Split Views system into the webpage layout.
