# AI Component Prompt: Dark Mode vs Light Mode Split (Comparison & Split Views)

```markdown
Implement the 'Dark Mode vs Light Mode Split' component from the Comparison & Split Views system into the webpage layout.
