# AI Component Prompt: Free vs Enterprise Visual Split (Comparison & Split Views)

```markdown
Implement the 'Free vs Enterprise Visual Split' component from the Comparison & Split Views system into the webpage layout.
