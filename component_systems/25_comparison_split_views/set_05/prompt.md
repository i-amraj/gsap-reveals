# AI Component Prompt: Cyberpunk System Delta View (Comparison & Split Views)

```markdown
Implement the 'Cyberpunk System Delta View' component from the Comparison & Split Views system into the webpage layout.
