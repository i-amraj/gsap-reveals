# AI Component Prompt: Draggable Before/After Splitter (Comparison & Split Views)

```markdown
Implement the 'Draggable Before/After Splitter' component from the Comparison & Split Views system into the webpage layout.
