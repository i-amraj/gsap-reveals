# AI Component Prompt: Interactive Code Diff Viewer (Comparison & Split Views)

```markdown
Implement the 'Interactive Code Diff Viewer' component from the Comparison & Split Views system into the webpage layout.
