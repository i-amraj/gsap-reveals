# AI Component Prompt: Multi-Step Onboarding Modal (Modals & Dialogs)

```markdown
Implement the 'Multi-Step Onboarding Modal' component from the Modals & Dialogs system into the webpage layout.
