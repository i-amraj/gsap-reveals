# AI Component Prompt: Destructive Action Confirm Modal (Modals & Dialogs)

```markdown
Implement the 'Destructive Action Confirm Modal' component from the Modals & Dialogs system into the webpage layout.
