# AI Component Prompt: Mobile Swipeable Bottom Sheet (Modals & Dialogs)

```markdown
Implement the 'Mobile Swipeable Bottom Sheet' component from the Modals & Dialogs system into the webpage layout.
