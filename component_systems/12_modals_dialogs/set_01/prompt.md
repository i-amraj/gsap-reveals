# AI Component Prompt: Glass Centered Alert Dialog (Modals & Dialogs)

```markdown
Implement the 'Glass Centered Alert Dialog' component from the Modals & Dialogs system into the webpage layout.
