# AI Component Prompt: Video Lightbox Media Modal (Modals & Dialogs)

```markdown
Implement the 'Video Lightbox Media Modal' component from the Modals & Dialogs system into the webpage layout.
