# AI Component Prompt: Slide-Over Right Action Drawer (Modals & Dialogs)

```markdown
Implement the 'Slide-Over Right Action Drawer' component from the Modals & Dialogs system into the webpage layout.
