# AI Component Prompt: Milestone Checkpoint Bar (Breadcrumbs & Steppers)

```markdown
Implement the 'Milestone Checkpoint Bar' component from the Breadcrumbs & Steppers system into the webpage layout.
