# AI Component Prompt: Numbered Circular Step Wizard (Breadcrumbs & Steppers)

```markdown
Implement the 'Numbered Circular Step Wizard' component from the Breadcrumbs & Steppers system into the webpage layout.
