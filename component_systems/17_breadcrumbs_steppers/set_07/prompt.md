# AI Component Prompt: Icon Flow Pipeline Header (Breadcrumbs & Steppers)

```markdown
Implement the 'Icon Flow Pipeline Header' component from the Breadcrumbs & Steppers system into the webpage layout.
