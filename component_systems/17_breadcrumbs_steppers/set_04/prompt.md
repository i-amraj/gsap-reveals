# AI Component Prompt: Horizontal Progress Timeline (Breadcrumbs & Steppers)

```markdown
Implement the 'Horizontal Progress Timeline' component from the Breadcrumbs & Steppers system into the webpage layout.
