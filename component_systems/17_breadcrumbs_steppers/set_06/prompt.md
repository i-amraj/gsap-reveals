# AI Component Prompt: Cyberpunk Data Node Stepper (Breadcrumbs & Steppers)

```markdown
Implement the 'Cyberpunk Data Node Stepper' component from the Breadcrumbs & Steppers system into the webpage layout.
