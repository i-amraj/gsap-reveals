# AI Component Prompt: Expanding Width Capsule Tabs (Tabs & Segmented Controls)

```markdown
Implement the 'Expanding Width Capsule Tabs' component from the Tabs & Segmented Controls system into the webpage layout.
