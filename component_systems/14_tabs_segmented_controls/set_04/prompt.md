# AI Component Prompt: Vertical Sidebar Tab System (Tabs & Segmented Controls)

```markdown
Implement the 'Vertical Sidebar Tab System' component from the Tabs & Segmented Controls system into the webpage layout.
