# AI Component Prompt: Icon + Label Segmented Switch (Tabs & Segmented Controls)

```markdown
Implement the 'Icon + Label Segmented Switch' component from the Tabs & Segmented Controls system into the webpage layout.
