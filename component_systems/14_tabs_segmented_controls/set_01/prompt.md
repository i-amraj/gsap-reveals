# AI Component Prompt: Sliding Magnetic Pill Segment (Tabs & Segmented Controls)

```markdown
Implement the 'Sliding Magnetic Pill Segment' component from the Tabs & Segmented Controls system into the webpage layout.
