# AI Component Prompt: Gradient Border Highlight Tab (Tabs & Segmented Controls)

```markdown
Implement the 'Gradient Border Highlight Tab' component from the Tabs & Segmented Controls system into the webpage layout.

Component Specifications:
- Category: Navigation & Filters
- Component Pattern: tabs
- Accent Color: #c084fc
