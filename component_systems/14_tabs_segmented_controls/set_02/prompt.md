# AI Component Prompt: Glass Underline Active Tab (Tabs & Segmented Controls)

```markdown
Implement the 'Glass Underline Active Tab' component from the Tabs & Segmented Controls system into the webpage layout.
