# AI Component Prompt: Spotlight Border Glow Card (Feature Cards & Teasers)

```markdown
Implement the 'Spotlight Border Glow Card' component from the Feature Cards & Teasers system into the webpage layout.
