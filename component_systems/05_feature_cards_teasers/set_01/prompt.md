# AI Component Prompt: 3D Parallax Tilt Card (Feature Cards & Teasers)

```markdown
Implement the '3D Parallax Tilt Card' component from the Feature Cards & Teasers system into the webpage layout.
