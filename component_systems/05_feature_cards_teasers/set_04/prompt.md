# AI Component Prompt: Expandable Drawer Preview Card (Feature Cards & Teasers)

```markdown
Implement the 'Expandable Drawer Preview Card' component from the Feature Cards & Teasers system into the webpage layout.

Component Specifications:
- Category: Cards & Containers
- Component Pattern: cards
- Accent Color: #10b981
