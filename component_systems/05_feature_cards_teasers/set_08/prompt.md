# AI Component Prompt: Interactive Metric Stat Card (Feature Cards & Teasers)

```markdown
Implement the 'Interactive Metric Stat Card' component from the Feature Cards & Teasers system into the webpage layout.
