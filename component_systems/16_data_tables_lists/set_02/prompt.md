# AI Component Prompt: Sortable Header Telemetry Grid (Data Tables & List Views)

```markdown
Implement the 'Sortable Header Telemetry Grid' component from the Data Tables & List Views system into the webpage layout.
