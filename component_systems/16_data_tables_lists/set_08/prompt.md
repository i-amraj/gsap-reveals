# AI Component Prompt: Minimalist Card List View (Data Tables & List Views)

```markdown
Implement the 'Minimalist Card List View' component from the Data Tables & List Views system into the webpage layout.
