# AI Component Prompt: Sticky Header Scrollable Table (Data Tables & List Views)

```markdown
Implement the 'Sticky Header Scrollable Table' component from the Data Tables & List Views system into the webpage layout.
