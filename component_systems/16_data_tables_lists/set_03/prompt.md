# AI Component Prompt: User Avatar Activity List (Data Tables & List Views)

```markdown
Implement the 'User Avatar Activity List' component from the Data Tables & List Views system into the webpage layout.
