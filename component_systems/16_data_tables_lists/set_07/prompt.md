# AI Component Prompt: Expandable Row Detail Grid (Data Tables & List Views)

```markdown
Implement the 'Expandable Row Detail Grid' component from the Data Tables & List Views system into the webpage layout.
