# AI Component Prompt: Minimalist Dark Review Pills (Testimonials & Social Proof)

```markdown
Implement the 'Minimalist Dark Review Pills' component from the Testimonials & Social Proof system into the webpage layout.
