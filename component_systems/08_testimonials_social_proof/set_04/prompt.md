# AI Component Prompt: Star Rating Carousel Slider (Testimonials & Social Proof)

```markdown
Implement the 'Star Rating Carousel Slider' component from the Testimonials & Social Proof system into the webpage layout.
