# AI Component Prompt: Video Avatar Review Reels (Testimonials & Social Proof)

```markdown
Implement the 'Video Avatar Review Reels' component from the Testimonials & Social Proof system into the webpage layout.
