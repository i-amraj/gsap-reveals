# AI Component Prompt: Monthly / Annual Billing Pill (Toggle Switches & Flippers)

```markdown
Implement the 'Monthly / Annual Billing Pill' component from the Toggle Switches & Flippers system into the webpage layout.
