# AI Component Prompt: Cursor-Tracking Magnetic Tooltip (Tooltips & Popovers)

```markdown
Implement the 'Cursor-Tracking Magnetic Tooltip' component from the Tooltips & Popovers system into the webpage layout.
