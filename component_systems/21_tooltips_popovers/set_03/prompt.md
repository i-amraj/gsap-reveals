# AI Component Prompt: Glass Frosted Shortcut Bubble (Tooltips & Popovers)

```markdown
Implement the 'Glass Frosted Shortcut Bubble' component from the Tooltips & Popovers system into the webpage layout.
