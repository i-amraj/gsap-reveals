# AI Component Prompt: Rich Card Popover with Actions (Tooltips & Popovers)

```markdown
Implement the 'Rich Card Popover with Actions' component from the Tooltips & Popovers system into the webpage layout.
