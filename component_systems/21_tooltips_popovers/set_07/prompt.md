# AI Component Prompt: Multi-Step Onboarding Tour Tip (Tooltips & Popovers)

```markdown
Implement the 'Multi-Step Onboarding Tour Tip' component from the Tooltips & Popovers system into the webpage layout.
