# AI Component Prompt: Cyberpunk Neon Tag Pointer (Tooltips & Popovers)

```markdown
Implement the 'Cyberpunk Neon Tag Pointer' component from the Tooltips & Popovers system into the webpage layout.
