# AI Component Prompt: Creative Studio Media Bento (Bento Grid Cards)

```markdown
Implement the 'Creative Studio Media Bento' component from the Bento Grid Cards system into the webpage layout.
