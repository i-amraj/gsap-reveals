# AI Component Prompt: Spinning Vinyl Record Player (Audio & Media Players)

```markdown
Implement the 'Spinning Vinyl Record Player' component from the Audio & Media Players system into the webpage layout.
