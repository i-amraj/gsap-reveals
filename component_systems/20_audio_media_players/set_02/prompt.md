# AI Component Prompt: Floating Capsule Music Pill (Audio & Media Players)

```markdown
Implement the 'Floating Capsule Music Pill' component from the Audio & Media Players system into the webpage layout.
