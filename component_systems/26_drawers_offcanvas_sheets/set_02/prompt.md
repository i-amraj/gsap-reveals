# AI Component Prompt: Left Sidebar Navigation Sheet (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Left Sidebar Navigation Sheet' component from the Drawers & Offcanvas Sheets system into the webpage layout.
