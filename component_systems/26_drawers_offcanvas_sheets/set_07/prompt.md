# AI Component Prompt: Multi-Panel Nested Drawer (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Multi-Panel Nested Drawer' component from the Drawers & Offcanvas Sheets system into the webpage layout.
