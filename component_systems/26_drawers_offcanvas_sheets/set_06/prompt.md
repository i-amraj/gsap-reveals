# AI Component Prompt: Cyberpunk Terminal Side Tray (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Cyberpunk Terminal Side Tray' component from the Drawers & Offcanvas Sheets system into the webpage layout.
