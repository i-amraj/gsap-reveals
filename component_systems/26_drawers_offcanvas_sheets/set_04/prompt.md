# AI Component Prompt: Fullscreen Overlay Canvas Drawer (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Fullscreen Overlay Canvas Drawer' component from the Drawers & Offcanvas Sheets system into the webpage layout.

Component Specifications:
- Category: Overlays & Canvas
- Component Pattern: drawers
- Accent Color: #ec4899
