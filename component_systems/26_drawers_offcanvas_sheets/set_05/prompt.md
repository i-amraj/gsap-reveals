# AI Component Prompt: Sticky Peek Mini Drawer (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Sticky Peek Mini Drawer' component from the Drawers & Offcanvas Sheets system into the webpage layout.
