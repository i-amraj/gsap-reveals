# AI Component Prompt: Glass Frosted Info Sidebar (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Glass Frosted Info Sidebar' component from the Drawers & Offcanvas Sheets system into the webpage layout.
