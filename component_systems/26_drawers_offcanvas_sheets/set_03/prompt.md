# AI Component Prompt: Bottom Mobile Filter Sheet (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Bottom Mobile Filter Sheet' component from the Drawers & Offcanvas Sheets system into the webpage layout.
