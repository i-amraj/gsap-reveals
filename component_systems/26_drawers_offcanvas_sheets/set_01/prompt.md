# AI Component Prompt: Right Slide E-Commerce Cart (Drawers & Offcanvas Sheets)

```markdown
Implement the 'Right Slide E-Commerce Cart' component from the Drawers & Offcanvas Sheets system into the webpage layout.
