# AI Component Prompt: Success Confetti Toast Pill (Alerts, Banners & Toasts)

```markdown
Implement the 'Success Confetti Toast Pill' component from the Alerts, Banners & Toasts system into the webpage layout.
