# AI Component Prompt: Gradient Highlight Notice Box (Alerts, Banners & Toasts)

```markdown
Implement the 'Gradient Highlight Notice Box' component from the Alerts, Banners & Toasts system into the webpage layout.
