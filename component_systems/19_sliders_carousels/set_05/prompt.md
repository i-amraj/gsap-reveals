# AI Component Prompt: Full-Width Hero Image Slider (Sliders & Carousels)

```markdown
Implement the 'Full-Width Hero Image Slider' component from the Sliders & Carousels system into the webpage layout.
