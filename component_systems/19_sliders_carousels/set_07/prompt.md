# AI Component Prompt: Cyberpunk Horizontal Showcase (Sliders & Carousels)

```markdown
Implement the 'Cyberpunk Horizontal Showcase' component from the Sliders & Carousels system into the webpage layout.
