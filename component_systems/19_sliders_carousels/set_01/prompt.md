# AI Component Prompt: Draggable Smooth Card Slider (Sliders & Carousels)

```markdown
Implement the 'Draggable Smooth Card Slider' component from the Sliders & Carousels system into the webpage layout.
