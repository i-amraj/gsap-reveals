# AI Component Prompt: Infinite Auto-Running Marquee (Sliders & Carousels)

```markdown
Implement the 'Infinite Auto-Running Marquee' component from the Sliders & Carousels system into the webpage layout.
