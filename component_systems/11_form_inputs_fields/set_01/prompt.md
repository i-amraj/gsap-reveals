# AI Component Prompt: Floating Label Animated Input (Form Inputs & Controls)

```markdown
Implement the 'Floating Label Animated Input' component from the Form Inputs & Controls system into the webpage layout.
