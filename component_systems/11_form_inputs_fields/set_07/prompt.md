# AI Component Prompt: File Drag & Drop Upload Zone (Form Inputs & Controls)

```markdown
Implement the 'File Drag & Drop Upload Zone' component from the Form Inputs & Controls system into the webpage layout.
