# AI Component Prompt: OTP 6-Digit Verification Boxes (Form Inputs & Controls)

```markdown
Implement the 'OTP 6-Digit Verification Boxes' component from the Form Inputs & Controls system into the webpage layout.
