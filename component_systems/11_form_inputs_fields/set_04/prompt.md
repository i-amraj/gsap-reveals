# AI Component Prompt: Credit Card Formatter Input (Form Inputs & Controls)

```markdown
Implement the 'Credit Card Formatter Input' component from the Form Inputs & Controls system into the webpage layout.
