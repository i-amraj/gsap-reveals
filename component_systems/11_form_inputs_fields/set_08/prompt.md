# AI Component Prompt: Terminal CLI Input Prompt (Form Inputs & Controls)

```markdown
Implement the 'Terminal CLI Input Prompt' component from the Form Inputs & Controls system into the webpage layout.
