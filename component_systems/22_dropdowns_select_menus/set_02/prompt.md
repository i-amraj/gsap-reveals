# AI Component Prompt: Multi-Select Tag Chip Menu (Dropdowns & Select Menus)

```markdown
Implement the 'Multi-Select Tag Chip Menu' component from the Dropdowns & Select Menus system into the webpage layout.
