# AI Component Prompt: Glass Frosted Context Menu (Dropdowns & Select Menus)

```markdown
Implement the 'Glass Frosted Context Menu' component from the Dropdowns & Select Menus system into the webpage layout.
