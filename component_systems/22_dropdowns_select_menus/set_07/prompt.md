# AI Component Prompt: Icon Prefix Quick Action Menu (Dropdowns & Select Menus)

```markdown
Implement the 'Icon Prefix Quick Action Menu' component from the Dropdowns & Select Menus system into the webpage layout.
