# AI Component Prompt: Searchable Filter Dropdown (Dropdowns & Select Menus)

```markdown
Implement the 'Searchable Filter Dropdown' component from the Dropdowns & Select Menus system into the webpage layout.
