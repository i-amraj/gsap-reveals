# AI Component Prompt: User Profile Avatar Menu (Dropdowns & Select Menus)

```markdown
Implement the 'User Profile Avatar Menu' component from the Dropdowns & Select Menus system into the webpage layout.
