# AI Component Prompt: Custom Animated Select Box (Dropdowns & Select Menus)

```markdown
Implement the 'Custom Animated Select Box' component from the Dropdowns & Select Menus system into the webpage layout.
