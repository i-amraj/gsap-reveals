# AI Component Prompt: Table Row Wave Loading State (Skeletons & Loading States)

```markdown
Implement the 'Table Row Wave Loading State' component from the Skeletons & Loading States system into the webpage layout.
