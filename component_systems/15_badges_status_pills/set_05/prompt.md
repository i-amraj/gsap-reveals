# AI Component Prompt: Cyberpunk Hazard Status Pill (Badges & Status Pills)

```markdown
Implement the 'Cyberpunk Hazard Status Pill' component from the Badges & Status Pills system into the webpage layout.
