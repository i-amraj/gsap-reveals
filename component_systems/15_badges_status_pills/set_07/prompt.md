# AI Component Prompt: Removable Dismiss Filter Chip (Badges & Status Pills)

```markdown
Implement the 'Removable Dismiss Filter Chip' component from the Badges & Status Pills system into the webpage layout.
