# AI Component Prompt: Numeric Counter Notification (Badges & Status Pills)

```markdown
Implement the 'Numeric Counter Notification' component from the Badges & Status Pills system into the webpage layout.
