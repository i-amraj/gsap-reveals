# AI Component Prompt: Pulsing Radar Live Ping Pill (Badges & Status Pills)

```markdown
Implement the 'Pulsing Radar Live Ping Pill' component from the Badges & Status Pills system into the webpage layout.
...
- Support hover, active, and keyboard focus accessibility rings (`outline: 2px solid #22c55e`).
