# AI Component Prompt: Shimmer Running Border Badge (Badges & Status Pills)

```markdown
Implement the 'Shimmer Running Border Badge' component from the Badges & Status Pills system into the webpage layout.
