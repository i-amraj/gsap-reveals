# AI Component Prompt: Glass Frosted Status Chip (Badges & Status Pills)

```markdown
Implement the 'Glass Frosted Status Chip' component from the Badges & Status Pills system into the webpage layout.
