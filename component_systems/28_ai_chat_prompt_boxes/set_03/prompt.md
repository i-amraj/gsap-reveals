# AI Component Prompt: AI Model Selector Dropdown Pill (AI Chat & Prompt Boxes)

```markdown
Implement the 'AI Model Selector Dropdown Pill' component from the AI Chat & Prompt Boxes system into the webpage layout.
