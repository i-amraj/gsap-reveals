# AI Component Prompt: Multi-Modal Attachment Drawer (AI Chat & Prompt Boxes)

```markdown
Implement the 'Multi-Modal Attachment Drawer' component from the AI Chat & Prompt Boxes system into the webpage layout.
