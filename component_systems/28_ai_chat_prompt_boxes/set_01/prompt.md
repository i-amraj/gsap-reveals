# AI Component Prompt: ChatGPT / Claude Floating Prompt Bar (AI Chat & Prompt Boxes)

```markdown
Implement the 'ChatGPT / Claude Floating Prompt Bar' component from the AI Chat & Prompt Boxes system into the webpage layout.
