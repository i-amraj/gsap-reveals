# AI Background Prompt: Dark Sumi Ink Wash (Monastic Zen Paper Texture)

```markdown
Implement the dedicated 'Dark Sumi Ink Wash' atmospheric visual background using the 'zen_ink_paper' engine.
