# AI Background Prompt: Monochrome Silver Curve (Flowing Sinewave Ribbons)

```markdown
Implement the dedicated 'Monochrome Silver Curve' atmospheric visual background using the 'sine_ribbons' engine.
