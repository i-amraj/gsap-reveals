# AI Background Prompt: Cyan Harmonic Flow (Flowing Sinewave Ribbons)

```markdown
Implement the dedicated 'Cyan Harmonic Flow' atmospheric visual background using the 'sine_ribbons' engine.
