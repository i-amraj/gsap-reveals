# AI Background Prompt: Tokyo Midnight Neon (Retro 80s Synth Horizon)

```markdown
Implement the dedicated 'Tokyo Midnight Neon' atmospheric visual background using the 'synthwave_sun' engine.
