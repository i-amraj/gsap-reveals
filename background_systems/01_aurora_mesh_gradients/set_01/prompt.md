# AI Background Prompt: Nordic Borealis Green (Aurora Mesh Gradients)

```markdown
Implement the dedicated 'Nordic Borealis Green' atmospheric visual background using the 'aurora' engine.
