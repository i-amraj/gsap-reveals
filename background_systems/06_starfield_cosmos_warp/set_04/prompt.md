# AI Background Prompt: Golden Supercluster Orbit (Starfield Cosmos Warp)

```markdown
Implement the dedicated 'Golden Supercluster Orbit' atmospheric visual background using the 'warp_stars' engine.
