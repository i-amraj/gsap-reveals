# AI Background Prompt: Midnight Ghost Haze (Smoke & Fluid Fog)

```markdown
Implement the dedicated 'Midnight Ghost Haze' atmospheric visual background using the 'smoke_fog' engine.
