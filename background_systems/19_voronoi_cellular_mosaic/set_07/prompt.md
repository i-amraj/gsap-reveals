# AI Background Prompt: Electric Cobalt Fracture (Voronoi Cellular Mosaic)

```markdown
Implement the dedicated 'Electric Cobalt Fracture' atmospheric visual background using the 'voronoi_cells' engine.
