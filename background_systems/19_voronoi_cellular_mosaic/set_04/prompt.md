# AI Background Prompt: Molten Basalt Plates (Voronoi Cellular Mosaic)

```markdown
Implement the dedicated 'Molten Basalt Plates' atmospheric visual background using the 'voronoi_cells' engine.
