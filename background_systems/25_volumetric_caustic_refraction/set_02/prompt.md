# AI Background Prompt: Emerald Lagoon Refraction (Volumetric Caustic Refraction)

```markdown
Implement the dedicated 'Emerald Lagoon Refraction' atmospheric visual background using the 'water_caustics' engine.
