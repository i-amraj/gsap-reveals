# AI Background Prompt: Pure Silver Liquid Ripple (Volumetric Caustic Refraction)

```markdown
Implement the dedicated 'Pure Silver Liquid Ripple' atmospheric visual background using the 'water_caustics' engine.
