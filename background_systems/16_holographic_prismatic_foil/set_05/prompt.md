# AI Background Prompt: Gold Holographic Stamp (Holographic Prismatic Foil)

```markdown
Implement the dedicated 'Gold Holographic Stamp' atmospheric visual background using the 'holo_foil' engine.
