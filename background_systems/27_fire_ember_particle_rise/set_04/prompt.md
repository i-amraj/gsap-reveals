# AI Background Prompt: Green Witchfire Embers (Fire Ember Particle Rise)

```markdown
Implement the dedicated 'Green Witchfire Embers' atmospheric visual background using the 'fire_embers' engine.
