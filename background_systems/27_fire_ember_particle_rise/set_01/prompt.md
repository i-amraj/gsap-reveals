# AI Background Prompt: Molten Forge Ember (Fire Ember Particle Rise)

```markdown
Implement the dedicated 'Molten Forge Ember' atmospheric visual background using the 'fire_embers' engine.
