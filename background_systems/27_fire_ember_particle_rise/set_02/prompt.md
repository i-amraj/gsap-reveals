# AI Background Prompt: Dragon Blood Crimson Flame (Fire Ember Particle Rise)

```markdown
Implement the dedicated 'Dragon Blood Crimson Flame' atmospheric visual background using the 'fire_embers' engine.
