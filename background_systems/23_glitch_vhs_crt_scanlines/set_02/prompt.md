# AI Background Prompt: Cyber Blue Surveillance CRT (Glitch VHS CRT Scanlines)

```markdown
Implement the dedicated 'Cyber Blue Surveillance CRT' atmospheric visual background using the 'crt_vhs_glitch' engine.
