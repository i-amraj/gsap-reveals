# AI Background Prompt: Synthwave Violet Tape (Glitch VHS CRT Scanlines)

```markdown
Implement the dedicated 'Synthwave Violet Tape' atmospheric visual background using the 'crt_vhs_glitch' engine.
