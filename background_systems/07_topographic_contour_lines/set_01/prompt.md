# AI Background Prompt: Alpine Elevation Slate (Topographic Contour Lines)

```markdown
Implement the dedicated 'Alpine Elevation Slate' atmospheric visual background using the 'contour' engine.
