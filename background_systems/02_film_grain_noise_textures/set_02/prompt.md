# AI Background Prompt: Retro Monochrome Newspaper (Film Grain & Noise Textures)

```markdown
Implement the dedicated 'Retro Monochrome Newspaper' atmospheric visual background using the 'grain' engine.
