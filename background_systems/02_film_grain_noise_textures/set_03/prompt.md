# AI Background Prompt: Warm Terracotta Studio (Film Grain & Noise Textures)

```markdown
Implement the dedicated 'Warm Terracotta Studio' atmospheric visual background using the 'grain' engine.
