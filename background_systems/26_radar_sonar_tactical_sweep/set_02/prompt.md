# AI Background Prompt: Tactical Amber Aircraft HUD (Radar Sonar Tactical Sweep)

```markdown
Implement the dedicated 'Tactical Amber Aircraft HUD' atmospheric visual background using the 'radar_sweep' engine.
