# AI Background Prompt: Lavender Mist & Charcoal (Duotone Gradient Maps)

```markdown
Implement the dedicated 'Lavender Mist & Charcoal' atmospheric visual background using the 'duotone_split' engine.
